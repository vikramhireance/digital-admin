                        ...
                        <div class="card p-2 m-5">
                            ...
                            <div class="card-header">
                                <div class="row align-items-left">
                                    <div class="col">
                                        <h2 class="card-title-lg">Edit Blog Category</h2>
                                    </div>
                                    <!--end col-->
                                </div>
                                <!--end row-->
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal auth-form my-4" method="post" id="submitForm" enctype="multipart/form-data"
                                    action="{{ asset('admin/blog-category/update') }}">
                                    @csrf
                                    ...
                                    <div class=" form-group imgPreview">
                                        <div class="col-sm-3">
                                            <img src="{{ asset('Upload/Blogs') }}/{{ $data->image }}" width="100%">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="form-control mb-3" name="meta_description">{{ $data->meta_description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
