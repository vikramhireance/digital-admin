                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" style="float: left;">SEO Details </h4>

                                <a href="{{asset('admin/manage_seo/add')}}" class="button button1" style="float: right;">
                                    +SEO
                                </a>
                            </div>
                            <!--end card-header-->
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        ...
                        url: "{{ route('admin.manage_seo_delete') }}",
                        type: "POST",
                        dataType: 'json',
