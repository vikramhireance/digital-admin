            ...
            <div class="row" style="justify-content: center">
                ...
                <div class="card-header">
                    <div class="row align-items-left">
                        <div class="col">
                            <h2 class="card-title-lg">About us</h2>
                        </div>
                        <!--end col-->
                    </div>
                    <!--end row-->
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal auth-form my-4" method="post" id="submitForm" action="{{ URL::to('admin/about_us/update') }}"
                        ...
                        <div class="form-group">
                            <label for="example-text-input-lg" >Sub Title</label>
                            <div class="col-md-12">
                                <input class="form-control mb-3" type="text" name="sub_title"
                                    placeholder="Enter Title" id="example-text-input-lg" value="{{ $data->sub_title }}">
                            </div>
                        </div>
                        <div class="form-group imgPreview">
                            <div class="col-sm-2">
                                <img src="{{ URL::to('AboutUs') . '/' . $data->image }}" class="editImg mb-2" width="100%">
                            </div>
                        </div>
                        <div class="form-group">
