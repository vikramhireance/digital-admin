                        ...
                        <div class="card p-2 m-5">
                            ...
                            <div class="card-header">
                                <div class="row align-items-left">
                                    <div class="col">
                                        <h2 class="card-title-lg">Edit portfolio</h2>
                                    </div>
                                    <!--end col-->
                                </div>
                                <!--end row-->
                            ...
                            <div class="card-body">
                                <form class="form-horizontal auth-form my-4" method="post" id="submitForm"
                                    enctype="multipart/form-data" action="{{ asset('admin/portfolio/update') }}">
                                    @csrf
                                    ...
                                    <div class=" form-group imgPreview">
                                        <div class="col-sm-2">
                                            <img src="{{ asset('Portfolios') }}/{{ $data->image }}" width="100%">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group imgPreview2">
                                        @if ($data->gallery_image)
                                            <div class="col-sm-2">
                                                <img src="{{ asset('Portfolios/gallery') }}/{{ $data->gallery_image }}"
                                                    width="100%">
                                            </div>
                                        @endif
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input class="form-control mb-3 file2" type="file" name="gallery_image"
                                                placeholder="Select gallery_image" id="example-text-input-lg">
                                        </div>
                                    </div>
                                    <div class="form-group">
