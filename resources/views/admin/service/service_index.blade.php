                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" style="float: left;">Services Details </h4>

                                <a href="{{asset('admin/service/add')}}" class="button button1" style="float: right;">
                                    + Add Service
                                </a>
                            </div>
                            <!--end card-header-->
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        ...
                        url: "{{ route('admin.service_delete') }}",
                        type: "POST",
                        dataType: 'json',
