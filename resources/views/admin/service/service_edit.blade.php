                        ...
                        <div class="card p-2 m-5">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal auth-form my-4" method="post" id="submitForm"
                                    enctype="multipart/form-data" action="{{ asset('admin/service/update') }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Description
                                            <button class="btn btn-primary get_chatgpt_data">get data</button>
                                        </label>
                                        <div class="col-sm-12 mb-3">
                                            <textarea class="ckeditor form-control" id="ckeditor" name="description">{{ $data->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input-lg"
