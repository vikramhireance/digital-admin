                        ...
                        <div class="page-title-box">
                            <div class="float-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Trusted By</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Trusted By Details</h4>

                                <a href="{{URL::to('admin/trusted_by/add')}}" class="button button1" style="float: right;">
                                    + Add Reiview
                            </a>
                            </div>
                            <!--end card-header-->
