                        ...
                        <div class="card-body">
                            <form class="form-horizontal auth-form my-4" method="post" id="submitForm" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control mb-3" type="text" name="facebook_URL" value="{{$data->facebook_URL}}" required
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control mb-3" type="text" name="instagram_URL" value="{{$data->instagram_URL}}" required
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control mb-3" type="text" name="linkedin_URL" value="{{$data->linkedin_URL}}" required
