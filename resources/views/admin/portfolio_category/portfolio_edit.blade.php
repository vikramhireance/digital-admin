                        ...
                        <div class="card p-2 m-5">
                            <div class="card-header">
                                <div class="row align-items-left">
                                    <div class="col">
                                        <h2 class="card-title-lg">Edit Portfolio Category</h2>
                                    </div>
                                    <!--end col-->
                                </div>
                                <!--end row-->
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal auth-form my-4" method="post" id="submitForm"
                                    enctype="multipart/form-data" action="{{ asset('admin/portfolio-category/update') }}">
                                    @csrf
                                    ...
                                    <div class=" form-group imgPreview">
                                        <div class="col-sm-2">
                                            <img src="{{ asset('Upload/Portfolios') }}/{{ $data->image }}" width="100%">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input-lg"
