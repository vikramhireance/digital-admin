                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Portfolio Category Details </h4>

                                <a href="{{asset('admin/portfolio-category/add')}}" class="button button1" style="float: right;">
                                    + Add Category
                                </a>
                            </div>
                            <!--end card-header-->
...
@section('js')
    ...
    <script>
        ...
        var table = $('.data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.portfolio_category') }}",
            columns: [{
                    data: 'id',
                    name: 'id'
                },
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        ...
                        url: "{{ route('admin.portfolio_category_delete') }}",
                        type: "POST",
                        dataType: 'json',
