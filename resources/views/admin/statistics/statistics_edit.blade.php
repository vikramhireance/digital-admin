                    ...
                    <div class="card p-2 m-5">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal auth-form my-4" method="post" id="submitForm" enctype="multipart/form-data"
                                action="{{ asset('admin/statistics/update') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control mb-3" type="phone" name="number" value="{{$data->number}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control mb-3" type="text" name="title" value="{{$data->title}}"
