                        ...
                        <div class="card p-2 m-5">
                            ...
                            <div class="card-header">
                                <div class="row align-items-left">
                                    <div class="col">
                                        <h2 class="card-title-lg">Header Image</h2>
                                    </div>
                                    <!--end col-->
                                </div>
                                <!--end row-->
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal auth-form my-4" method="post" id="submitForm"
                                    action="{{ URL::to('admin/header_image/update') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group imgPreview">
                                        <div class="col-sm-2">
                                            <img src="" class="editImg mb-2"
                                                width="100%">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input-lg">Aboutus  Image</label>
                                        <div class="col-sm-12">
                                            <input class="form-control mb-3 file1" type="file" name="aboutus"
