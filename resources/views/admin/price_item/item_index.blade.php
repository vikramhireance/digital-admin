                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Prcing Details </h4>

                                <a href="{{URL::to('admin/pricing_items/add')}}" class="button button1" style="float: right;">
                                    + Add Pricing Items
                                </a>
                            </div>
                            <!--end card-header-->
...
@section('js')
    ...
    <script>
        ...
        var table = $('.data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.pricing_items') }}",
            columns: [{
                    data: 'id',
                    name: 'id'
                },
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        ...
                        url: "{{ route('admin.pricing_items_delete') }}",
                        type: "POST",
                        dataType: 'json',
