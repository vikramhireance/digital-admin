                        ...
                        <div class="card p-2 m-5">
                            ...
                            <div class="card-header">
                                <div class="row align-items-left">
                                    <div class="col">
                                        <h2 class="card-title-lg">Add Pricing Items</h2>
                                    </div>
                                    <!--end col-->
                                </div>
                                <!--end row-->
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal auth-form my-4" method="post" id="submitForm"
                                    enctype="multipart/form-data" action="{{ URL::to('admin/pricing_items/store') }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label>Price</label>
                                        <div class="col-md-12">
                                            <select name="price_id" id="" class="form-control mb-3">
